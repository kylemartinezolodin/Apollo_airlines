    ...
    <body>
        ...
        <div class="body_container">
            ...
            <div class="interface">
                    ...
                    <ul>
                        <li class="def"><a class="navigation" href="welcome.html">BOOK A FLIGHT</a></li>
                        <li class="current_li"><a class="current_a" href="search.html">SEARCH A FLIGHT</a></li>
                    ...
                    <div class="booking_container">
                        <div class="center">
                            ...
                            <form>
                                ...
                                <div style="marg">
                                    <button type="submit" name="book-btn">Search</button>
                                </div>
                            </form>
                        </div>
                    </div> 
